        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
                ...
                <router-link to="/" class="sidebar-brand d-flex align-items-center justify-content-center">
                    ...
                    <div class="sidebar-brand-text mx-3">Monkey planner</div>
                </router-link>
                ...
                <li class="nav-item active">
                    <router-link to="/" class="nav-link">
                        ...
                        <span>Nástěnka</span></router-link>
                </li>
 ...
 * Main app component.
 *
 * This component wraps all user interface of planner SPA.
 */
export default {
    name: "App",
    components: {Navbar, DashboardPage},
    mounted() {
